...
public class CardPaymentTest {
    ...
    @DisplayName("1.1.2 Payment for the tour by credit card, card with the status \"APPROVED\"")
    @Test
    ...
    @DisplayName("1.2.1 Payment for the tour by debit card, card with the status \"DECLINED\"")
    @Test
    ...
    @DisplayName("1.2.2 Payment for the tour by credit card, card with the status \"DECLINED\"")
    @Test
    ...
    @DisplayName("1.3.1 Payment for the tour by debit card, valid card number, boundary values of input fields \"Month\" and \"Year\"")
    @Test
    ...
    @DisplayName("1.3.2 Payment for the tour by credit card, valid card number, boundary values of input fields \"Month\" and \"Year\"")
    @Test

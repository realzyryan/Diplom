...
public class FieldCvcCvvTest {
    ...
    @DisplayName("6.1.1 Payment for the tour by debit card, one number for CVC/CVV")
    @Test
    ...
    @DisplayName("6.1.2 Payment for the tour by credit card, one number for CVC/CVV")
    @Test
    ...
    @DisplayName("6.2.1 Payment for the tour by debit card, two numbers for CVC/CVV")
    @Test
    ...
    @DisplayName("6.2.2 Payment for the tour by credit card, two numbers for CVC/CVV")
    @Test
    ...
    @DisplayName("6.3.1 Payment for the tour by debit card, empty CVC/CVV number input")
    @Test
    ...
    @DisplayName("6.3.2 Payment for the tour by credit card, empty CVC/CVV number input")
    @Test
    ...
    @DisplayName("6.4.1 Payment for the tour by debit card, CVC/CVV number is all 0")
    @Test
    ...
    @DisplayName("6.4.2 Payment for the tour by credit card, CVC/CVV number is all 0")
    @Test
    ...
    @DisplayName("6.5.1 Payment for the tour by debit card, invalid CVC/CVV number")
    @Test
    ...
    @DisplayName("6.5.2 Payment for the tour by credit card, invalid CVC/CVV number")
    @Test
    ...
    @DisplayName("6.6.1 Payment for the tour by debit card, long CVC/CVV number")
    @Test
    ...
    @DisplayName("6.6.2 Payment for the tour by credit card, long CVC/CVV number")
    @Test

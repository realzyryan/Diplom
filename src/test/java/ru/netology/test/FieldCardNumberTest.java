...
public class FieldCardNumberTest {
    ...
    @DisplayName("2.1.1 Payment for the tour by debit card, short card number")
    @Test
    ...
    @DisplayName("2.1.2 Payment for the tour by credit card, short card number")
    @Test
    ...
    @DisplayName("2.2.1 Payment for the tour by debit card, empty card number input")
    @Test
    ...
    @DisplayName("2.3.1 Payment for the tour by debit card, long card number")
    @Test
    ...
    @DisplayName("2.3.2 Payment for the tour by credit card, long card number")
    @Test
    ...
    @DisplayName("2.4.1 Payment for the tour by debit card, card number is all 0")
    @Test
    ...
    @DisplayName("2.4.2 Payment for the tour by credit card, card number is all 0")
    @Test
    ...
    @DisplayName("2.5.1 Payment for the tour by debit card, invalid card number")
    @Test
    ...
    @DisplayName("2.5.2 Payment for the tour by credit card, invalid card number")
    @Test

...
public class FieldMonthTest {
    ...
    @DisplayName("3.1.1 Payment for the tour by debit card, short month number")
    @Test
    ...
    @DisplayName("3.1.2 Payment for the tour by credit card, short month number")
    @Test
    ...
    @DisplayName("3.2.1 Payment for the tour by debit card, empty month number input")
    @Test
    ...
    @DisplayName("3.2.2 Payment for the tour by credit card, empty month number input")
    @Test
    ...
    @DisplayName("3.3.1 Payment for the tour by debit card, month number is all 0")
    @Test
    ...
    @DisplayName("3.3.2 Payment for the tour by credit card, month number is all 0")
    @Test
    ...
    @DisplayName("3.4.1 Payment for the tour by debit card, non-existent month number")
    @Test
    ...
    @DisplayName("3.4.2 Payment for the tour by credit card, non-existent month number")
    @Test
    ...
    @DisplayName("3.5.1 Payment for the tour by debit card, invalid month number")
    @Test
    ...
    @DisplayName("3.5.2 Payment for the tour by credit card, invalid month number")
    @Test
    ...
    @DisplayName("3.6.1 Payment for the tour by debit card, long month number")
    @Test
    void shouldNotSubmitApplicationLongMonthNumber() {
        paymentPage.openCardPaymentPage();
        paymentPage.fillMonthField(longMonthInvalid);
        fillOtherFieldsByValidInfo();
    ...
    @DisplayName("3.6.2 Payment for the tour by credit card, long month number")
    @Test

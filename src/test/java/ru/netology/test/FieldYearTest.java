...
public class FieldYearTest {
        ...
        @DisplayName("4.1.1 Payment for the tour by debit card, short year number")
        @Test
        ...
        @DisplayName("4.1.2 Payment for the tour by credit card, short year number")
        @Test
        ...
        @DisplayName("4.2.1 Payment for the tour by debit card, empty year number input")
        @Test
        ...
        @DisplayName("4.2.2 Payment for the tour by credit card, empty year number input")
        @Test
        ...
        @DisplayName("4.3.1 Payment for the tour by debit card, year number is all 0")
        @Test
        ...
        @DisplayName("4.3.1 Payment for the tour by credit credit card, year number is all 0")
        @Test
        ...
        @DisplayName("4.4.1 Payment for the tour by debit card, last year")
        @Test
        ...
        @DisplayName("4.4.2 Payment for the tour by credit card, last year")
        @Test
        ...
        @DisplayName("4.5.1 Payment for the tour by debit card, invalid year number")
        @Test
        ...
        @DisplayName("4.5.2 Payment for the tour by credit card, invalid year number")
        @Test
        ...
        @DisplayName("4.6.1 Payment for the tour by debit card, full year number")
        @Test
        ...
        @DisplayName("4.6.2 Payment for the tour by credit card, full year number")
        @Test
